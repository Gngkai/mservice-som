...
public class aos_mkt_3design_bill extends AbstractBillPlugIn implements ItemClickListener {
        ...
        if ("设计需求表".equals(aos_source)) {
            ...
            if (count == 0) {
                ...
                DynamicObject aos_mkt_designreq =
                    BusinessDataServiceHelper.loadSingle(aos_sourceid, "aos_mkt_designreq");
            ...
            // 24-1-3 来样拍照，直接结束
                ...
                AosMktProgPhReqBill.generateDesign(aos_mkt_photoreq);
                ...
                MKTCom.SendGlobalMessage(MessageId, "aos_mkt_photoreq", String.valueOf(aos_sourceid), String.valueOf(aos_orignbill),
                    "开发/采购确认图片");
    ...
    public static void Generate3Design(List<DynamicObject> list3d, DynamicObject dy_mian) throws FndError {
        ...
        for (int i = 0; i < list3d.size(); i++) {
            ...
            aos_entryentity.set("aos_is_design",
                skuList.contains(dyn3d_r.getDynamicObject("aos_itemid").getString("id")));
        ...
        if (operationrst.getValidateResult().getValidateErrors().size() != 0) {
            MKTCom.SendGlobalMessage(MessageId, String.valueOf(aos_mkt_3design), String.valueOf(operationrst.getSuccessPkIds().get(0)),
