	...
	private void KEY_AOS_ASSIGN() {
		...
		try {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				DynamicObject bill = BusinessDataServiceHelper.loadSingle(para, "aos_mkt_popadds");
				...
				if (!Status.equals("A")) {
					...
					OperationResult operationrst = OperationServiceHelper.executeOperate("save", "aos_mkt_popadds",
