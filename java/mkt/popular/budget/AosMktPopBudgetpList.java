 ...
 * @version 预算调整-列表插件
 */
public class AosMktPopBudgetpList extends AbstractListPlugin {
    ...
    private void aosInit() {
        ...
        AosMktPopBudgetpTask.manualitemClick(params);
        this.getView().invokeOperation("refresh");
        this.getView().showSuccessNotification("已手工提交预算调整(推广)初始化,请等待,务重复提交!");
    }
    ...
    private void keyAssign() {
        ...
        try {
            ...
            for (ListSelectedRow listSelectedRow : list) {
                ...
                DynamicObject bill = BusinessDataServiceHelper.loadSingle(para, "aos_mkt_pop_budgetp");
