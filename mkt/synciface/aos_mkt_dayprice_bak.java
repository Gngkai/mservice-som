	...
	public static void do_operate(Map<String, Object> param) {
		...
		if (length > 0) {
			...
			for (int i = 0; i < length; i++) {
				...
				Object aos_orgid = aos_sal_import_pub.get_import_id(RankJson.get("aos_ou_code"), "bd_country");
				Object aos_itemid = aos_sal_import_pub.get_import_id(RankJson.get("aos_productid"), "bd_material");
				...
				aos_entryentity.set("aos_currentprice", RankJson.get("aos_currentprice"));
			}
