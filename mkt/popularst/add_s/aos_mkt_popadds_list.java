...
public class aos_mkt_popadds_list extends AbstractListPlugin {
	...
	private void KEY_AOS_ASSIGN() {
		...
		try {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				DynamicObject bill = BusinessDataServiceHelper.loadSingle(para, "aos_mkt_pop_addst");
				...
				if (!Status.equals("A")) {
					...
					OperationResult operationrst = OperationServiceHelper.executeOperate("save", "aos_mkt_pop_addst",
