...
public class VCES implements ActStrategy {
    @Override
    public void doOperation(DynamicObject object) throws Exception {
        ...
        // 同店铺
        Set<String> daysBeforeAndAfterActItem = ActUtil.query30DaysBeforeAndAfterActItem(aos_orgid, null,new String[]{aos_shopnum}, start, 30);
        Set<String> amzDaysBeforeAndAfterActItem = ActUtil.query30DaysBeforeAndAfterActItem(aos_orgid, new String[]{"AMAZON"}, null, start, 30);
        // 第一次过滤选品清单
        ...
        for (DynamicObject obj : selectList) {
            ...
            if (amzDaysBeforeAndAfterActItem.contains(aos_sku)) {
                MKTCom.Put_SyncLog(aos_sync_logS, aos_sku + " 剔除亚马逊SC前后30天已提报活动的SKU");
                continue;
            }
